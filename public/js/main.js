                        ...
                        `<div id="alert-toast" class="alert-toast-2">
                            ...
                            <div class="alert-toast-2-content">
                                <div class="mb-10" ${style}>
                                    Đơn hàng <b>#${notificationObject.id_dh}</b> đã được giao thành công. Cảm ơn bạn đã mua hàng tại Cadozvex, chúng tôi xin gửi tặng bạn mã giảm giá... <a href="taikhoan/thongbao">Chi tiết</a>
                                </div>
                                <div class="d-flex justify-content-end align-items-center mr-5">
                                    <div class="dot-green mr-5"></div>
                                    <div class="fst-italic fw-lighter fz-12">Bây giờ</div>
