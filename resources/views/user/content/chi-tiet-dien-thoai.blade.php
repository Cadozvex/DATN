@extends("user.layout")
@section("title") {{$phone['tensp']}} | Cadozvex @stop
@section("content")
        ...
        <div class='row'>
            ...
            @else
                <div class='col-lg-4 col-md-6 mb-20 fz-14'>
                    ...
                    <div>
                        Liên hệ
                        <b class="ml-5 mr-5">099 999 9999</b>hoặc
                        <b class="ml-5 mr-5">094 972 5843</b> Để được tư vấn
                    </div>
                    <hr>
                    @include('user.content.components.chitiet.right-side')
                </div>
                                                ...
                                                <div class='d-flex'>
                                                    ...
                                                    <div class='d-flex flex-column justify-content-between pl-20'>
                                                        <div class="d-flex align-items-center flex-wrap">
                                                            ...
                                                            <div class="success-color fz-14"><i class="fas fa-check-circle mr-5"></i>Đã mua hàng tại Cadozvex</div>
                                                        </div>
