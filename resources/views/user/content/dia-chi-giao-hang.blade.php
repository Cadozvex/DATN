<!DOCTYPE html>
<html lang="en">
    @section("title")Địa chỉ giao hàng | Cadozvex @stop
    @include("user.header.head")
<body class="address-delivery-bg">
    <div class="address-delivery-header">
        <div class="container">
            <img src="images/logo/Cadozvex.png" alt="logo" width="80px">
        </div>
    </div>
    ...
    <div class="loader"><div class="loader-bg"></div><div class="loader-img"><img src="images/logo/Cadozvex.png" alt=""></div><div class="spinner-border" role="status"></div></div>
