...
@section("breadcrumb")
    ...
    @switch($page)
        ...
        {{-- đơn hàng --}}
        @case('sec-don-hang')
            @section("title")Đơn hàng | Cadozvex @stop
