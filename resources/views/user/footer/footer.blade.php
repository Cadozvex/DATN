<section class="white-bg">
    ...
    <div class="relative">
        ...
        <div class="footer-big-img">
            <img src="images/logo/Cadozvex-logo.png" alt="">
        </div>
        <div class="middle-footer">
            <div class="container">
                    ...
                    <div class="col-lg-8 col-sm-12 mb-40">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6 mb-20">
                                ...
                                <div class="d-flex flex-column mt-20">
                                    <div>Gọi mua:  <b>099 999 9999</b></div>
                                    <div>Kỹ thuật: <b>094 972 5843</b></div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="d-flex justify-content-center">
                                    <div class='d-flex flex-column align-items-center'>
                                        <img src="images/logo/logo.png" alt="logo-footer" width="100px">
                ...
                <div class="copyright-footer">
                    Copyright &copy; 2023 Cadozvex. All rights severved.
                </div>
            </div>
        </div>
    </div>
