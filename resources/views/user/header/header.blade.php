        ...
        <div class="d-flex align-items-center">
            ...
            <div class="w-7">
                <a href="{{route('user/index')}}" class='head-brand'>
                    <img src="images/logo/Cadozvex.png" alt="Logo">
                </a>
            </div>
    ...
    <div class='row'>
        <div class='col-lg-10 col-12'>
            <div class='d-flex flex-column justify-content-center p-20'>
                <a href="{{route('user/index')}}"><img src="images/logo/Cadozvex.png" class='head-offcanvas-img'></a><hr>
                ...
                <div class='d-flex justify-content-start'>
                    <div class='d-flex flex-column pt-20'>
                        ...
                        <div class='d-flex flex-column mt-10 ml-30'>
                            <span><i class="fas fa-phone mr-5"></i>099 9999999</span>
                            <span><i class="fas fa-phone mr-5"></i>094 9725843</span>
                        </div>
                    </div>
                </div>
            </div>
